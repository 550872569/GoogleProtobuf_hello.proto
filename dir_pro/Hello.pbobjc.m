...
#pragma mark - HLWHelloRoot

@implementation HLWHelloRoot

@end

#pragma mark - HLWHelloRoot_FileDescriptor

static GPBFileDescriptor *HLWHelloRoot_FileDescriptor(void) {
  ...
  if (!descriptor) {
    ...
    GPBDescriptor *localDescriptor =
        [GPBDescriptor allocDescriptorForClass:[HLWHelloRequest class]
                                     rootClass:[HLWHelloRoot class]
                                          file:HLWHelloRoot_FileDescriptor()
                                        fields:fields
